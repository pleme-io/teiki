    ...
    crates = {
      ...
      "shikumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "a97c2185d7be127e966126dacdff80000ef5be7e";
          sha256 = "1bd33ch6rs6kjz2fk0y3gaxnx7rzmcyqvmym8fqdj0k629fxg64b";
        };
        dependencies = [
          {
            name = "arc-swap";
      ...
      "teiki" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt-multi-thread" "process" "time" "signal" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
        ...
        resolvedDefaultFeatures = [ "default" "webhooks" ];
      };
      "thiserror" = rec {
        crateName = "thiserror";
        version = "2.0.18";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "io-util" "libc" "macros" "mio" "net" "process" "rt" "rt-multi-thread" "signal" "signal-hook-registry" "socket2" "sync" "time" "tokio-macros" "windows-sys" ];
      };
      "tokio-macros" = rec {
